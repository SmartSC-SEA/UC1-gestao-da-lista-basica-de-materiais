...
contract diagramD {
    ...
    string disapproval = "Disapproved";


    function order(string memory orderDispatchDate_, string memory orderDispatchForm_, string memory orderDispatchNumber_, string memory invoiceNumber_, string memory invoiceUrl_, 
    string memory deliveryAdress_, string memory deliveryAdressComp_, string memory deliveryNeigh_, string memory deliveryCity_, string memory deliveryState_, string memory deliveryCep_) public {
    ...
    function disapprove() external view returns (string memory) {
        return disapproval;
    }
}